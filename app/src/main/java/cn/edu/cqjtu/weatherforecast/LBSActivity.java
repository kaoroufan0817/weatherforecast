...
public class LBSActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity__lbs);
        ...
        //原因不明，在onRequestPermissionsResult()方法中animateMapStatus(update)能执行但不能定位
        //要在onCreat()中加此语句
        LatLng ll = new LatLng(31.249, 120.699);
    ...
    private void navigateTo(BDLocation location) {
        if (isFirstLocate) {
            Toast.makeText(this, "移动到 " + location.getAddrStr(), Toast.LENGTH_SHORT).show();
            ...
            //Toast.makeText(LBSActivity.this,"定位方法运行了",Toast.LENGTH_SHORT).show();
        }
