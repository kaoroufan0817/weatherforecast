...
public class WeatherActivity extends AppCompatActivity {
    ...
    private ImageButton toolButoon;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolButoon = (ImageButton) findViewById(R.id.tool_button);
        ...
        toolButoon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WeatherActivity.this,ToolActivity.class);
    ...
    public void requestWeather(final String weatherId){
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId + "&key=10f71b2d8cf5490f9cd6be98aa150620";
        //指定Url则可以正常显示 经检测为weatherId错误
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        //这里弹出消息为unkowncity 表示请求数据有问题
                        if(weather != null && "ok".equals(weather.status)){
                            //将两个值分别设为true发现是右侧表达式为假
                            SharedPreferences.Editor editor = PreferenceManager.getDefaultSharedPreferences(WeatherActivity.this).edit();
                            editor.putString("weather",responseText);
                            editor.apply();
                            showWeatherInfo(weather);
                        }else {
                            //Toast.makeText(WeatherActivity.this,"这里出错了",Toast.LENGTH_SHORT).show();
                            Toast.makeText(WeatherActivity.this,"获取天气信息失败",Toast.LENGTH_SHORT).show();
                        }
